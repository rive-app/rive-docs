...
<AccordionGroup>
    ...
    <Accordion title="Nested Text">
        ...
        | Flutter (rive_native) | ✅ `>= 0.0.1-dev.6` |
        | Apple | ✅ `6.1.0+` |
        | Android (Compose) | Unsupported |
        | Android (Legacy) | ✅ `9.8.0+` |
        | C++ | ✅ Supported |
        | Unity | ✅ Supported |
        | Unreal | ✅ `0.1.14+` |
    </Accordion>
    <Accordion title="Nested Inputs">
        ...
        | React | ✅ `4.11.3+` |
        | React Native | ✅ `v0.1.4+` |
        | React Native (Legacy) | ✅ `7.2.0+` |
        | Flutter | ✅ `0.13.7+` |
        | Flutter (rive_native) | ✅ `>= 0.0.1-dev.6` |
        | Apple | ✅ `5.13.2+` |
        | Android (Compose) | Unsupported |
        | Android (Legacy) | ✅ `9.4.2+` |
        | C++ | ✅ Supported |
        | Unity | ✅ `0.1.174+` |
        | Unreal | ✅ Supported |
    </Accordion>
    ...
    <Accordion title="Nested Inputs and Nested Events">
        ...
        | React | ✅ `4.5.0+` |
        | React Native | ✅ `v0.1.4+` |
        | React Native (Legacy) | ✅ `6.2.0+` |
        | Flutter | ✅ `0.12.3+` |
        | Flutter (rive_native) | ✅ `>= 0.0.1-dev.6` |
        | Apple | ✅ `5.6.0+` |
        | Android (Compose) | Unsupported from API |
        | Android (Legacy) | ✅ `8.7.0+` |
        | C++ | ✅ Supported |
        | Unity | ✅ Supported |
    </Accordion>
