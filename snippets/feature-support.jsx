    ...
    const features = {
        statefulComponents: {
            ...
            runtimes: {
                ...
                reactCanvas: { supported: true, version: "4.3.0+" },
                reactCanvasLite: { supported: true, version: "4.3.0+" },
                reactWebGL: { supported: true, version: "4.3.0+" },
                reactWebGL2: { supported: true, version: "4.3.0+" },
