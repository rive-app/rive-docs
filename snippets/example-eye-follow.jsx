      ...
      const r = new rive.Rive({
        ...
        onLoad: () => {
          ...
          handleMouseMove = (event) => {
            // Use window dimensions instead of canvas dimensions
            const xValue = mapCursorToRange(event.clientX, window.innerWidth);
            const yValue = mapCursorToRange(event.clientY, window.innerHeight);
