...
ii. _No Training; Zero Data Retention Policy_. Rive will not use User Content or data included in Inputs or Outputs to train the LLMs that power the AI Features and has a "**zero data retention**" policy with such third-party LLMs.
