...
<CardGroup cols="2">
  <Card title="1. Design" img="/images/introduction/animation.gif">
    Build static or animated states, like walking, running, enabled, and disabled.
  </Card>
  <Card title="2. Animate" img="/images/introduction/animation.gif">
    Build static or animated states, like walking, running, enabled, and disabled.
  </Card>
  <Card title="3. Make Interactive" img="/images/introduction/animation.gif">
    Build static or animated states, like walking, running, enabled, and disabled.
  </Card>
  <Card title="4. Control using Data" img="/images/introduction/animation.gif">
    Build static or animated states, like walking, running, enabled, and disabled.
  </Card>
  <Card title="5. Publish Anywhere" img="/images/introduction/publish.gif">
    Your Rive file is fully functional and ready to be used in your website, mobile app, or game.
  </Card>
</CardGroup>
