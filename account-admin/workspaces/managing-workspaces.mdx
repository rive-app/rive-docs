...
<Note>
  If you want to cancel your plan without permanently deleting your files, see [Cancel Your Plan](/account-admin/account-overview/cancel-my-plan).
</Note>

To permanently delete a workspace for all members, including all files in the workspace, see [Deleting a Workspace](/account-admin/workspaces/delete-a-workspace).
