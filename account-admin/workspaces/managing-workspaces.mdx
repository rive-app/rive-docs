...
<AccordionGroup>
  <Accordion title="I upgraded but it still says my workspace is free.">
  ...
  <Accordion title="I upgraded but only one workspace changed. Why aren't all my workspaces paid now?">
