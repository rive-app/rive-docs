...
<AccordionGroup>
	<Accordion title="Why can't I find my Rive file">
		Rive files live in the workspace they were created in or shared with. Try looking for it in a [different workspace](/account-admin/workspaces/workspaces#switching-workspaces).
	</Accordion>
</AccordionGroup>