...
You can listen for pointer events inside any script that implements `pointerDown`, `pointerMove`, `pointerUp`, or `pointerExit`. These functions can be defined in [Drawing Scripts](/scripting/protocols/drawing-scripts) and [Layout Scripts](/scripting/protocols/layout-scripts).
...
If you need to listen for Pointer Events in your [instantiated artboards](/scripting/protocols/drawing-scripts#instanting-components),
