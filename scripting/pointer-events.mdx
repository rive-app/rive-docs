...
You can listen for pointer events inside any script that implements `pointerDown`, `pointerMove`, `pointerUp`, or `pointerExit`. These functions can be defined in [Drawing Scripts](/scripting/script-types/drawing-scripts) and [Layout Scripts](/scripting/script-types/layout-scripts).
...
If you need to listen for Pointer Events in your [instantiated artboards](/scripting/script-types/drawing-scripts#instanting-components),
