...
Define the uniform data in your WGSL shader and assign it to a bind group and binding:
...
Bind the group to the render pass before drawing. When a uniform changes, write the new value to its buffer to make it available to the shader.

Uniform values can come from script inputs, allowing them to be configured in the Editor, animated, or controlled with data binding.
