...
Use `draw` to draw the rendered canvas image into the Rive scene and for GPU rendering. This is where you begin a render pass, set the pipeline, and issue draw calls.
