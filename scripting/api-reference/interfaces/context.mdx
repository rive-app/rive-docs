...
<div class="signature">
```lua
globalViewModel(name: string) -> ViewModel?
```
</div>

Returns the global [ViewModel](/scripting/api-reference/interfaces/view-model) with the given name, or nil if there is no
