...
Returns the [ViewModel](/scripting/api-reference/artboards/view-model) bound to the node's immediate data context. This is the most common way
...
Returns the [ViewModel](/scripting/api-reference/artboards/view-model) bound to the root artboard's data context.
