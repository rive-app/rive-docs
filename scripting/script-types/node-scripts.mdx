...
- [Creating a script](/scripting/creating-scripts)
- Return function
- Lifecycle functions

- Adding scripts to an scene
...
[Create a new Script](/scripting/creating-scripts) of type Node.
...
- Select the script in the Hierarchy, inputs in the right sidebar
- Data bind your inputs
