...
Drawing scripts can be used to render shapes, images, text, artboards, and more.

## Creating a Drawing Script

1. [Create a new script](/scripting/creating-scripts) and select **Drawing** as the type.
2. [Add it to the scene](/scripting/creating-scripts#adding-scripts-to-your-scene).

## Anatomy of a Drawing Script
...
Drawing scripts allow you to draw shapes and render them in your scene.
