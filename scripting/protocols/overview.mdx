...
- [Blank](/scripting/protocols/util-scripts) - Share helper logic across your other scripts.
- [Test](/scripting/protocols/test-scripts) - Unit test your functions.
- **File Format** - Read and write your own binary file format inside the Editor.
- **Text File Format** - Read and write a text-based format, and drive the Editor's text intelligence for it.
