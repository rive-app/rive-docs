...
<Tip>
  Using inputs, instances of Artboards can be added to your scene at runtime. See [Instantiating Components](/scripting/protocols/drawing-scripts#instanting-components).
</Tip>

## Setting Input Values

To access the input properties in the right sidebar of the editor, select your [Drawing](/scripting/protocols/drawing-scripts) or [Layout script](/scripting/protocols/layout-scripts) in the Hierarchy Panel or the [Converter](/scripting/protocols/converter-scripts) in the Data Panel.

![Drawing script input](/images/scripting/script-input.png)
...
<Note>
  ...
  If you need to control a view model property from your script, use [View Model Inputs](#view-model-inputs)
</Note>
...
Your script can only access View Models that are nested inside your Main View Model.
...
```lua
function moveCharacter(self: MyDrawing)
