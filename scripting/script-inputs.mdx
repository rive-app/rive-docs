...
Inputs let you customize your [Drawing](/scripting/protocols/drawing-scripts), [Layout](/scripting/protocols/layout-scripts), and [Converter](/scripting/protocols/converter-scripts) scripts with unique data that can be bound to view model properties.
