...
Inputs let you customize your [Drawing](/scripting/script-types/drawing-scripts), [Layout](/scripting/script-types/layout-scripts), and [Converter](/scripting/script-types/converter-scripts) scripts with unique data that can be bound to view model properties.
...
<Tip>
  Using inputs, instances of Artboards can be added to your scene at runtime. See [Instantiating Components](/scripting/script-types/drawing-scripts#instanting-components).
</Tip>

## Setting Input Values

To access the input properties in the right sidebar of the editor, select your [Drawing](/scripting/script-types/drawing-scripts) or [Layout script](/scripting/script-types/layout-scripts) in the Hierarchy Panel or the [Converter](/scripting/script-types/converter-scripts) in the Data Panel.
