...
To run [Drawing](/scripting/script-types/drawing-scripts) and [Layout](/scripting/script-types/layout-scripts) scripts, they need to be added to the scene.

1. Right-click the artboard you'd like to add your script to and select your script from the menu
2. Position the script object, keeping in mind that script's position will determine where it's rendered
