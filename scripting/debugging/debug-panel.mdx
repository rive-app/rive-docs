---
title: "Debug Panel"
description: "The Debug Panel lets you inspect script output and detect issues in your code."
---
...
<Note>
  If you are troubleshooting script behavior, check your file-level [Script Settings](/scripting/script-settings). Lower optimization and higher debug settings can make debugging easier.
</Note>