...
When the Console is tab is active, you have access to more options, including Copy Console and Clear Console.

![Problems panel](/images/scripting/debugging/debug-panel-elipsis.png)
