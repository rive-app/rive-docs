...
<Warning>
   MCP Integration was an experimental feature and is only available in Early Access. For most use cases, you should use the [AI Agent](/editor/ai-agent/) instead.
</Warning>
