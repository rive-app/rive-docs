...
<Steps>
  ...
  <Step title="Save The configuration">
    Save the following JSON snippet to your computer as `msp.json`.
  ```json
  {
    "mcpServers": {
        "rive": {
  ...
  <Step title="Configure MCP">
    ...
    Otherwise, you can use Terminal. Open Terminal.app and run the following commands:
    ```bash
    # In a standard Cursor installation
