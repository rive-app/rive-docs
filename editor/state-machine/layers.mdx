...
Layers farther to the right take priority over layers to the left. In most cases, this does not matter. However, if multiple layers control the same object property, the animation in the rightmost layer takes priority as the layers mix.
