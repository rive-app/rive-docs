...
![Add a new Layer](https://ucarecdn.com/a6d3e96f-a049-40fd-8ec5-f85301c76a7d/)
...
![Move layers](https://ucarecdn.com/5826dbf5-6762-424e-a347-65557cebfdbd/)
...
![Delete layer](/images/editor/state-machine/state-machine-layer-disable.gif)

**Disable and Enable layer**

You can delete a layer with right click over the name and selecting the option "Delete Layer".

![Delete layer](https://ucarecdn.com/5826dbf5-6762-424e-a347-65557cebfdbd/)