...
<Warning>
  We strongly recommend controlling your Rive file through [Data Binding](../data-binding), rather than Inputs. Not only is Data Binding more powerful, it's easier to [control via code at runtime](../../runtimes/data-binding).

  Data Binding includes all the functionality of Inputs, as well as the ability to control colors, enums, and strings.
</Warning>
