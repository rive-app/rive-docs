...
You can create multiple transitions between the same two states. Each transition can have different [condition](#transition-conditions), allowing you to create “or” logic.
...
- Events
- Built-in properties such as artboard width, height, and aspect ratio

![Comparisons](/images/editor/state-machine/transitions/source-value.png)
...
![Comparisons](/images/editor/state-machine/transitions/comparisons.png)

#### Comparison Value

The comparison value is the value the source value is compared against.

![Comparisons](/images/editor/state-machine/transitions/comparison-value.png)
