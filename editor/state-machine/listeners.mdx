...
<Demos examples={["listenerExamples"]} />
...
| **Pointer Drag**                  | Fires repeatedly as the pointer moves after being pressed down on the target, until the pointer is released.  |
