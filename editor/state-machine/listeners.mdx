...
![Button without Listener](https://ucarecdn.com/a2beca1f-6273-444d-8d57-47a91d8c6c61/)
...
![Button with a Listener](https://ucarecdn.com/700db248-e784-42d0-ba04-e6f551eb4403/)
...
![Creating a new Listener](https://ucarecdn.com/c32710a7-61ef-424b-a123-8586b8dcb760/)
...
![Listener properties](/images/editor/state-machine/c1b3fa7c-4eed-4be7-a64f-5ce0deeba0f8.webp)
...
![Automatically add target](https://ucarecdn.com/d94b83dd-95cb-4c6d-976c-fa959bd67dd2/)
...
![Manually add target](https://ucarecdn.com/02b7c53d-d2b7-458f-a7ff-9073f211bf41/)

**Opaque Target**

By default, target areas do not respect the draw order established in the Hierarchy; This allows target areas to detect actions, no matter where they are in that order. While this is useful in many scenarios, overlapping target areas can cause multiple listeners to fire at the same time.

![Clean Shot2025 04 10at17 04 06 Gi](/images/CleanShot2025-04-10at17.04.06.gif)

The Opaque Target option gives us the ability to prevent user actions from affecting targets below the Listener target.

![Clean Shot2025 04 10at17 04 57 Gi](/images/CleanShot2025-04-10at17.04.57.gif)
...
![Image](/images/editor/state-machine/a4304a3e-00b4-4368-a68a-ba7a3c04f446.webp)
