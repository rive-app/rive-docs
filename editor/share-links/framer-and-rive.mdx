...
![Grouped Rive and button component](https://ucarecdn.com/c4628cfc-1609-4a91-a92b-872d82d51fda/)
...
![Adding a variant where `isPressed` is set to "Yes"](https://ucarecdn.com/8be626b1-c9b1-4f1b-ae24-9ad24376740a/)
...
<Info>Note that in the example scenario above, a similar outcome could have been achieved through using [Listeners](../state-machine/listeners) in the Rive editor, but because we want to advance a state machine from outside of the Rive canvas, we need to manipulate state machine inputs manually.</Info>