...
<Note>You can now use the official [Rive Framer Plugin](https://www.framer.com/marketplace/plugins/rive/) to more easily integrate Rive graphics into Framer</Note>

<YouTube id="jM8DQmPw0pc" />

## Overview

Framer allows users to build functional websites fast in a low/no-code platform. Integrate Rives into Framer sites to build and control animations and interactive content without having to write custom code with [runtimes](/runtimes/). See more below on how to get started.
...
<Steps>
    <Step title="Make a Share Link">
        <Note>Generating share links is only available on Voyager and Enterprise plans. [Learn more about our plans and pricing](https://rive.app/pricing).</Note>

        To start, generate a new share link in the Rive editor and copy the *Framer code* snippet from the Rive editor.

        ![Framer code snippet generated from the Rive editor](https://1159711764-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F-M3EXlibk6bj2FzPQW-9%2Fuploads%2F7ZGX3RytiAvH75XRzFhD%2FScreen%20Shot%202022-08-15%20at%206.26.22%20PM.png?alt=media&token=56fa8038-882a-4426-8aa9-4bc04441200c)
    </Step>
    <Step title="Paste Code Snippet into Framer">
        ...
        ![Adding a Code component in Framer](https://ucarecdn.com/7be0d865-9add-49e4-9c11-e72390f5fe8b/)
        ...
        ![Rive Framer snippet pasted in a new component](https://ucarecdn.com/88d187a1-83d8-4100-a0a9-3ef3fd953a5f/)
        ...
        ![Adding a Rive code component to a page](https://ucarecdn.com/6ddb1c8c-1ac7-44da-8b8f-0e9253de5086/)
    </Step>
    <Step title="Control your Rive file in Framer">
        ...
        ![Image](/images/editor/share-links/f80052b3-bee4-4347-8da7-e1cf4b68e076.webp)
    </Step>
</Steps>
...
Learn more about the different options here: [Layout](/editor/layouts/layouts-overview)
...
![Grouped Rive and button component](/images/editor/share-links/c4628cfc-1609-4a91-a92b-872d82d51fda.webp)
...
![Adding a variant where `isPressed` is set to "Yes"](/images/editor/share-links/8be626b1-c9b1-4f1b-ae24-9ad24376740a.webp)
...
![Connecting button interactions to the SwitchOn variant](https://ucarecdn.com/eec38d46-5746-495f-8d1c-6d3e689681e0/)
...
![Button toggling a Rive state machine input](https://ucarecdn.com/d367027a-cd53-4bb8-ac68-1ab8533c197b/)
...
<Info>Note that in the example scenario above, a similar outcome could have been achieved through using [Listeners](/editor/state-machine/listeners) in the Rive editor, but because we want to advance a state machine from outside of the Rive canvas, we need to manipulate state machine inputs manually.</Info>