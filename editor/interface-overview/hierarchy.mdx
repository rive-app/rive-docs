...
As mentioned above, this panel allows you to switch between the Hierarchy, Assets Panel, and Data Panel. Read more about each panel below. To switch between the different panels, click on the desired panel.
