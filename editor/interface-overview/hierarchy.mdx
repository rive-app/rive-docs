...
The assets panel is where all of your Images, Lottie files, and Custom fonts will be added and appear. Read more about importing assets [Importing Assets](/editor/fundamentals/importing-assets).