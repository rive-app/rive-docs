...
- **Transform Tools**: Select, transform, rotate, scale, and [freeze](/editor/fundamentals/freeze-and-origin).
- **Arrangement Tools**: Create [artboards](/editor/fundamentals/artboards), [layouts](/editor/layouts/layouts-overview), [groups](/editor/fundamentals/groups), and [solos](/editor/manipulating-shapes/solos).
- **Create Tools** - [Pen](/editor/fundamentals/pen-tool-overview) and [Shapes tools](/editor/fundamentals/procedural-shapes).


- **Tools**: [add rigging](/editor/manipulating-shapes/manipulating-shapes), and more
