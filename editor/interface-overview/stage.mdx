...
Rulers display measurements along the edges of the Stage and can be used to create guides.

To show or hide rulers, open **View Options** and toggle **Rulers & Guides**, or press **;**.

See [Guides](/editor/design/guides) for information about creating and configuring guides for an artboard.
