...
<Tip>Corner radius also determines the shape of the Layout's clipping bounds, so if you enable clipping on the Layout, its children will be clipped using the corner radius values</Tip>
