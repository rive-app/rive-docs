...
Unlike [inviting someone to collaborate](/workspaces/managing-workspace-members#inviting-users-to-a-workspace), an embed URL is a **snapshot** of your file at the moment it’s generated. If you make changes later, you’ll need to generate a new link to reflect those updates.
