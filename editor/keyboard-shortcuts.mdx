...
| [Pen Tool Overview](./fundamentals/pen-tool-overview) | <kbd>P</kbd> |
| [Artboards](./fundamentals/artboards)                 | <kbd>A</kbd> |
| [Bones](./manipulating-shapes/bones)                  | <kbd>B</kbd> |
| [Groups](./fundamentals/groups)                       | <kbd>G</kbd> |
| [Freeze and Origin](./fundamentals/freeze-and-origin) | <kbd>Y</kbd> |
