...
To create a chain of bones activate the Bone tool in the [Transform Tools menu](/editor/interface-overview/overview#toolbar) (or press `B`) and click anywhere.
