...
<Tip>
  ...
  <Steps>
    <Step title="Create a new converter">
      ...
      ![Add menu in the Data panel showing the Group option in the Converter submenu](/images/accessibility/reduced-motion/create-converter-group.png)
    </Step>
    <Step title="Add a Toggle converter">
      ...
      ![Add menu in the Converter Group panel showing the Toggle option in the Boolean submenu](/images/accessibility/reduced-motion/create-toggle-converter.png)
    </Step>
    <Step title="Add a Convert to Number converter">
      This transforms a `boolean` to a number where `true = 1` and `false = 0`.

      ![Add menu in the Converter Group panel showing the Convert to Number option in the Numeric submenu](/images/accessibility/reduced-motion/create-convert-to-number.png)
    </Step>
    <Step title="Data bind the animation speed">
      ...
      ![Data Bind popover with Property set to prefersReducedMotion and Convert set to the BooleanToSpeed converter](/images/accessibility/reduced-motion/boolean-to-speed.png)
    </Step>
  </Steps>
