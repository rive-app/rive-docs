...
- [Fonts](/editor/assets/fonts): TTF, OTF
...
![Upload from the Assets panel](/images/editor/assets/asset-panel-upload.png)
...
* [Font Files](/editor/assets/fonts) for adding custom and Google Fonts.
...
<img src="/images/editor/assets/assets-sidebar.png" style={{maxWidth: "50%"}} />
...
See [Font Assets](/editor/assets/fonts#export-settings) for font-specific export settings, like Include.
