...
![The Rive editor in Animate Mode showing a state machine graph with Entry, Character idle, and transition states in the bottom panel](/images/editor/fundamentals/State_Machine.png)
