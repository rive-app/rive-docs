---
title: "xxxDesign vs Animate Mode"
...
Use Design Mode to prepare your graphics for animation. This is where you can design your own graphics with Rive's [tools](/editor/interface-overview/overview#toolbar), [import graphics from other software](/editor/fundamentals/importing-assets), or rig your graphics with [bones](/editor/manipulating-shapes/bones), [transform spaces](/editor/fundamentals/transform-spaces), [layouts](/editor/layouts/layouts-overview), [joysticks](/editor/manipulating-shapes/joysticks), and [constraints](/editor/constraints/constraints-overview).
