...
![Image](images/editor/fundamentals/components-animations-remap.gif)
...
**Using Events** Additionally, we can use Listeners to listen for Events firing from our Component, and change inputs accordingly.
