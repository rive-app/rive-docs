...
<img
  ...
  alt="Clicking between artboards on the Stage moves the Active tag to the clicked artboard's name"
  title="Active Gi"
  style={{ width:"100%" }}
/>
...
![Selecting a state machine from the default state machine dropdown](/images/defaultSM.gif)
...
![Holding shift and space bar in Design Mode to play the default state machine](/images/playDefault.gif)
...
![Setting artboard dimensions and clicking Create Artboard; Alternatively, selecting the artboard tool and clicking on the Stage to create an artboard](/images/create_AB.gif)
...
![Inspector panel listing an artboard's position, size, layout, fill, origin, and render preset properties](/images/artboard_prop.png)
...
![Width and Height fields in the artboard inspector](/images/WandH.png)
...
![Size Type dropdown showing fit mode options under the Width and Height fields](/images/size_type.png)
...
![X and Y origin fields set to 0%, placing the origin at the artboard's top left](/images/origin.png)
...
![Layout properties section in the artboard inspector](/images/layout.png)
...
![Fill and stroke section in the artboard inspector](/images/fillandstroke.png)
...
![Panel listing all colors used across objects inside the selected artboard](/images/selectColor.png)
