...
Since an Artboard is the root object that all other objects are added, Artboards allow you to add and adjust its layout properties. Read more about layouts [here](https://rive.app/docs/editor/layouts/layouts-overview).
