...
Artboards are the foundation of your composition across both design and animate mode. They act as the root of every hierarchy and allow you to define a scene's dimensions and background color. You can create infinite artboards on the [Stage](../interface-overview/stage), but each Rive file has at least one artboard.
