...
Artboards can also be converted to [components](/editor/components), allowing you to create and control multiple instances of an artboard within your composition.
...
The width and height define the artboard's dimensions in Rive. The size and aspect ratio at runtime may differ depending on the available space and your [layout settings](/editor/layouts).
...
Artboards can't be nested directly inside other artboards. To nest an artboard, first convert it to a [component](/editor/components).
...
See [Hierarchy](/editor/fundamentals/hierarchy) for more information about organizing and navigating objects.
...
See [Animations](/editor/animate-mode) and [State Machines](/editor/state-machine) to learn more.
...
- **Layout** - Control how the artboard responds when its size changes. See [Layout](/editor/layouts/layout).
