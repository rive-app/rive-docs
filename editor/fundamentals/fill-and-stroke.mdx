...
To create a fill, select a shape, then use the plus button under the Fill section of the Inspector. Be sure to select Fill from the new menu. You'll be able to tell that a layer is a fill by looking at the color selector on the left side. Fills have the selected color fill the box.

### **Changing Fill color**

To change the color of a Fill, select the color box on the left side of the Fill layer.

With the color box open, you can either click and drag within the
