...
<Note>
  Importing Lottie files is available on the Enterprise plans. [Learn more about our plans and pricing](https://rive.app/pricing).

  Lottie files can introduce risks that vary across customer setups, and implementing them without our guidance can lead to issues in performance, security, or reliability. Helping customers assess and mitigate these risks takes significant time and effort, which is why this level of support is only available on Enterprise.
</Note>
