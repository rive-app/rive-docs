...
Font variables can be animated in Rive. Open the variable fly-out in Animate [animate mode](/editor/fundamentals/design-vs-animate-mode) to key the available axes.
