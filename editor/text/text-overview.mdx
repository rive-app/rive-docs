...
Use the Text Tool to add and format text on an artboard. Text can automatically size to its content or wrap within a defined area.
...
![Text elements showing the various overflow options](/images/editor/design/text/text-alignment.png)
</Note>
