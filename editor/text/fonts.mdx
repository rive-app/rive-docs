...
See [Importing Assets](/editor/fundamentals/assets-overview#importing-assets) for information about importing TTF and OTF files.
...
![Glyphs used hack](/images/editor/assets/export-scripts.png)