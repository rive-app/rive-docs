...
Lottie files can vary significantly depending on how they were created, exported, and used. Importing them into Rive can introduce risks that vary across customer setups, including performance, security, and reliability considerations. Helping customers assess and mitigate these risks takes significant time and support, which is why this workflow is available on Enterprise.
