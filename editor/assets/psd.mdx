...
You can adjust export options for individual layers or for all layers in the PSD. See [Assets](/editor/assets/assets#export-options) for more about export behavior.
