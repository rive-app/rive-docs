...
<VideoEmbed src="https://static.rive.app/video/data-bind-font.mp4" />

<Marketplace
  href="https://rive.app/community/files/28431-data-binding-fonts/"
/>

<Note>
  Font properties affect a **single instance**.

  If you need to update a font globally across your entire file, use [asset loading instead](/runtimes/loading-assets). Asset loading replaces the underlying asset, updating all instances that use it.
</Note>
