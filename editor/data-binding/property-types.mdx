...
<Note>
  If you want to assign a View Model instance to a nested component, that instance must be reachable from your main View Model.

  Only View Model instances connected to the main View Model hierarchy are exported. Standalone instances that are not referenced will not be available at runtime.
</Note>

## List

List properties store collections of view models, which can be associated with specific artboards.
