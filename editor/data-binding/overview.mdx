...
- Bind values to a player's score, health, or username.
...
4. [Data can be updated](/data-binding/controlling-data) from the Editor, runtime code, state machines, or scripting.
