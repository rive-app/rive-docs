...
Audio events use sounds from the Assets panel. See [Importing Assets](/editor/fundamentals/assets-overview#importing-assets) to import MP3, WAV, and FLAC files, or see [Audio Assets](/editor/assets/audio-assets) to browse Soundly sounds, create clips, and adjust asset volume.
