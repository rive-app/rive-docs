...
Rive supports several types of Events:

- [Open URL Event](/editor/events/open-url-events) — Opens a URL at runtime
- [Audio Event](/editor/events/audio-events) — Plays a sound
- [General Event (deprecated for runtime communication)](/editor/events/general-events) — Previously used to communicate with runtime code
...
<Steps>
  ...
  <Step title="Select an Event type">
    ...
    Each event type has a different set of properties.
  </Step>
