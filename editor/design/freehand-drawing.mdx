...
<Tip>
  Hold <kbd>⌘</kbd> (or <kbd>Ctrl</kbd> on Windows) to temporarily switch to the **Shape Bend Tool** and see how **Simplify** affects the number of vertices created while erasing.
</Tip>