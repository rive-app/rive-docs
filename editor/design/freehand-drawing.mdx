...
![Selecting a brush shape and adjusting its width and smoothing settings]

<Note>
  Use the **Shape Bend Tool** to adjust the width at specific points along a spine.
</Note>

#### Editing Spines

Select **Edit Spines** to edit the vertices of all spines in the Brush Shape at once. You can also select an individual spine to edit it independently.

![Selecting a brush shape, clicking Edit Spines, and editing a spine]

#### Flattening Spines

Select **Flatten** to bake all spines into regular vector geometry. You can also flatten an individual spine without flattening the others.
...
![Drawing with a round and flat tip brush]
...
![Drawing with a larger and smaller Min Width]
...
![Drawing with higher and lower smoothing]
...
![Drawing higher and lower Stabilize values]
...
![Drawing multiple strokes that add to the same brush shape]
...
[Erasing various paths and shapes]
...
[Erasing a flattened shape with high and low Simplify settings]