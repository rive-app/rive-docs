...
Use ruler guides to place individual horizontal or vertical guides, or use guides to create structured rows, columns, and grids. Guides are specific to the artboard they're created on and are only visible in the editor—they aren't included in the exported `.riv`- **Show or hide:** Click the **eye** icon next to a guide.
- **Remove:** Click the **-** icon to remove the guide. file.
