...
<VideoEmbed src="https://static.rive.app/video/shape-builder.mp4" />

<Marketplace
  href="https://rive.app/community/files/28403-53691-shape-builder"
/>
...
<Steps>
  ...
  <Step title="Subtract regions">
    Hold <kbd>Alt</kbd> (Windows) or <kbd>Option</kbd> (macOS) while dragging to remove regions from the shape.
