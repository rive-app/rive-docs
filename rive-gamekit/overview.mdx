...
Creators are already experimenting with Rive for game development, and popular game development solutions have implemented Rive within their engines, such as [NoesisGUI](https://rive.app/use-cases/) and [Defold](https://defold.com/extension-rive/).
