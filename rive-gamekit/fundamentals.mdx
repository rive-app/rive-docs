...
<Note>
 **Just want to see the code?** Skip to the [example code](/rive-gamekit/fundamentals#example-code) section for the full code example.
</Note>

![Image](https://ucarecdn.com/c8bdce17-00cb-4321-bb62-387dc666157f/)

Drawing a Zombie with the Rive GameKitGetting Started - Flutter
...
Within the root of your project, create an **/assets** folder, and add your **.riv** files to it. You can create your own animations on [rive.app](https://rive.app/) or get inspiration from the [community](https://rive.app/community/files).
...
<Note>
 Download [this Rive file](https://ucarecdn.com/c6faf84c-5edc-4d06-8939-e0541afa9646/) for use with the rest of the tutorials
</Note>
...
**If you’re not familiar with Artboards in Rive, see our doc on Artboards below:**
...
<CardGroup>
  ...
  >
    Artboards are the foundation of your composition across both design and animate mode. They act as the root of every hierarchy and allow you to define the dimensions and background color of a scene.
  </Card>
</CardGroup>
...
![Image](https://ucarecdn.com/fff80772-35a5-4467-b48c-237454a616d5/)

*Artboard drawn without state machine advancement*
...
If you’re not familiar with State Machines in Rive, see our docs on State Machines below:
...
![Image](https://ucarecdn.com/360a3962-4350-44e7-bbbc-07f4d4823e68/)

*Zombie state machine animations*
...
![Image](https://ucarecdn.com/7671dbf5-5a91-4b07-94f1-4fedaf6f1b93/)

*State machine advancing by elapsed seconds*
...
![Image](https://ucarecdn.com/7a9e509b-e612-40a4-bc34-0f26e98b29ac/)

*State machine advancing by double the elapsed seconds*
...
You can read up on the main differences in when to use which `advance` method for better performance and best practices on the [Advancing state Machines](./advancing-state-machine) page.
