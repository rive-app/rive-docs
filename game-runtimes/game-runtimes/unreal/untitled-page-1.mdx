...
<Steps>
  ...
  <Step>
    Verify your **Artboard** tick and render loop is explicit and centralized (prefer C++).
  </Step>
</Steps>
...
Use this mapping for most projects:

- Legacy boolean input → **Boolean property**
- Legacy number input → **Number property**
- Legacy trigger input → **Trigger Property**
...
<Tip>
Keep Blueprints reactive. Avoid per-frame polling graphs. Centralize ticking and ownership in C++ where possible.
</Tip>
...
<Steps>
  ...
  <Step>
    Run a full regression pass on interactivity and UI flows.
  </Step>
</Steps>
...
- Review **ViewModels & Data Binding**
- Review **Observing ViewModel Changes**
