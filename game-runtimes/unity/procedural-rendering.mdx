...
- **Paint**: describes how to draw a shape - see [**Paint**](https://help.rive.app/game-runtimes/unity/procedural-rendering#paint).
- **PaintingStyle**: determines if the shape is filled or stroked.
- **Path**: defines a shape's outline or a clipping mask - see [**Path**](https://help.rive.app/game-runtimes/unity/procedural-rendering#path).
