...
For more information on Rive Listeners see the [editor documentation](https://rive.app/community/doc/listeners/doceaiA9rRW1).
...
<CardGroup col="auto">
  <Card title="Listeners"  icon={<svg xmlns="http://www.w3.org/2000/svg" height="100%" fill="none" viewBox="0 0 16 16" class="size-4 text-gray-500/80 dark:text-gray-400" aria-hidden="true"><path fill="currentColor" fill-rule="evenodd" d="M8.036 1v4.178c0 1.034.839 1.873 1.873 1.873h4.003v6.178a1.77 1.77 0 0 1-1.77 1.77H3.858a1.77 1.77 0 0 1-1.771-1.77V2.771A1.77 1.77 0 0 1 3.857 1zm1.25.145v4.033c0 .345.279.624.623.624h3.889a1.8 1.8 0 0 0-.377-.597L11.618 3.32 9.842 1.525a1.8 1.8 0 0 0-.557-.38" clip-rule="evenodd"></path></svg>}>
    ...
    <br />
    <a href="../../editor/state-machine/listeners" target="_blank"></a>
  </Card>
</CardGroup>
...
<Tabs>
    <Tab title="Components">
        ...
        [Panel Renderers](https://rive.app/community/doc/components/docZxgcghXbV#panel-renderers) are responsible for passing pointer input to  **Rive Panels.**
    ...
    <Tab title="Low-level API">
        ...
        ![Image](https://ucarecdn.com/c4b499ac-b42b-4b40-a071-b34f9e82e62a/)
        ...
        ![Image](https://ucarecdn.com/376abe7c-09b9-4234-b98f-fb8a67f24aa1/)
