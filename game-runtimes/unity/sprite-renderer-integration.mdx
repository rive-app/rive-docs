...
While Rive works well with Unity overall, **Sprite Renderers** don't natively handle Render Textures optimally. There are two main approaches to work around this:
...
If you need to maintain sort order when mixing Rive content with **Sprite Renderers**, you can use the following custom shader:
