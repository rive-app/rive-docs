...
While Rive works well with Unity overall, **Sprite Renderers** don't [natively handle Render Textures optimally](https://discussions.unity.com/t/how-to-apply-a-render-texture-from-a-camera-to-a-sprite-for-an-object-with-sprite-renderer/257199). There are two main approaches to work around this:
...
If you need to maintain sort order when mixing Rive content with **Sprite Renderers**, you can reference the following custom shader as a starting point:
...
![Setting the OverrideTexture property with a Rive Texture Renderer](/unity-spriterenderer-override-texture-property.jpg)