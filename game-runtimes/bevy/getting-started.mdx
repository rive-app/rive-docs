...
You can choose to load a [LinearAnimation](https://app.outverse.com/rive/doc/animation-playback/docDKKxsr7ko)[ ](https://app.outverse.com/rive/doc/animation-playback/docDKKxsr7ko)or [StateMachine](https://app.outverse.com/rive/doc/state-machines/docxeznG7iiK) from the provided Rive asset.
