...
- **Binding Targets**: Instances can be bound to:
  ...
  - `FRiveStateMachine` – synchronizes ViewModel data with state machine inputs and outputs. Currently, binding to a `URiveArtboard` automatically binds to the state machine.
