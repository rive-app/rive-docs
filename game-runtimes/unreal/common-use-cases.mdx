...
<Note>
  If you're using a worldspace widget (e.g. a Widget component added to your actor), you can simply enable "Receive Hardware Input" on the component to have it respond to mouse events. The method below is only necessary if you're using a Rive texture in worldspace.
</Note>
...
1. Enable "Support UV from hit results" in your Project Settings.
   ...
   ![Supportuvs Pn](/images/unreal/supportuvs.png)
2. Create a blueprint that translates mouse location to aretboard hits. The Topography Map level in the Rive Unreal Demos repository has an example of a Macro that does this using line traces:

   ![Mousttoartboard Pn](/images/unreal/mousttoartboard.png)
3. Call the Macro for the corresponding events and pass them to the artboard:

   ![Screenshot2025 05 23113944 Pn](/images/unreal/Screenshot2025-05-23113944.png)
