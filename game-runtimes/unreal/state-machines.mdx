...
You can call these functions on nested inputs by using the node equivalents that end in "at Path". See the [Nested Artboards](/editor/fundamentals/components) documentation for more details on using nested artboards.
