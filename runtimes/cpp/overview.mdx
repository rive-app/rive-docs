...
**`File` / `Artboard` / `Scene` know nothing about the GPU**, and
`Renderer` / `RenderContext` know nothing about Rive content. Either half
works on its own — render Rive content through your own `Renderer`
