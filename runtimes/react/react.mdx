...
<iframe height="700" width= "100%" scrolling="no" title="Untitled" src="https://codesandbox.io/p/sandbox/rive-quick-start-react-4xy76h" frameborder="no" loading="lazy" allowtransparency="true" allowfullscreen="true"></iframe>
...
Check out this example to see this pattern in use: [https://codesandbox.io/p/sandbox/userive-wrapper-pattern-6svl7k](https://codesandbox.io/p/sandbox/userive-wrapper-pattern-6svl7k)
