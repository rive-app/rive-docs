...
<Tabs>
    ...
    <Tab title="React">
        ...
        Supply the `textRunName`, the new `textRunValue` , and the component `path` where it is located.
    ...
    <Tab title="Apple">
        ...
        Similar to [reading text from a text run within a parent artboard](/runtimes/text#reading-text), you can set the value of a text run within a component instance using the following API:
        ...
        Additionally, similar to [setting text within a parent artboard](/runtimes/text#setting-text), you can read the value of a text run within a component instance using the following API:
