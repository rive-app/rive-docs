    ...
    <Tab title={Apple.currentRuntimeName}>
        <Steps>
            ...
            <Step title="Add a View">
                ...
                Alternatively, you can also specify which artboard and state machine to use. Documentation and examples for manually selecting which artboard to use is available in the [Artboards](/runtimes/android/artboards#choosing-an-artboard) documentation. Documentation and examples for manually selecting which state machine to use is available in the [State Machines](/runtimes/apple/state-machines#getting-a-state-machine) documentation.
            </Step>
