  ...
  <Tab title="React Native">
    <Tabs>
      <Tab title="New Runtime (Recommended)">
        <Warning>
          This functionality is deprecated. We recommend using [Data Binding](runtimes/data-binding).
        </Warning>
...
<Warning>
  ...
  **Use [Data Binding](/runtimes/data-binding) instead** for controlling
...
<Tabs>
  ...
  <Tab title="React Native">
    <Tabs>
      <Tab title="New Runtime (Recommended)">
        <Warning>
          **Note:** The new runtime recommends using [Data Binding](/runtimes/data-binding) instead of the legacy Inputs system for controlling nested component properties.
        </Warning>
