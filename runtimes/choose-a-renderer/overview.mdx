...
| --- | --- | --- |
| Android | Rive | Rive / Canvas / Skia (deprecated in v10.0.0) |
...
<Tabs>
    ...
    <Tab title="Android">
        ...
        The Rive Renderer was made the default in the Android runtime starting at **v10.0.0**, however, we recommend installing the latest version of the dependency to get the latest updates. See the [CHANGELOG](https://github.com/rive-app/rive-android/blob/master/CHANGELOG.md) for details on the latest versions.
    </Tab>
...
<Tabs>
    ...
    <Tab title="Android">
        ...
        Options: `Rive (default) / Skia (deprecated in v9.0.0) / Canvas`
