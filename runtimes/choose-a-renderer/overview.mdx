...
| [Android (Legacy)](#android-legacy)     | Canvas             | Canvas / Skia (removed as of v10.0.0) |
| [React Native](#react-native) | Rive             | *See Apple and Android*                      |
...
<Tabs>
    ...
    <Tab title="React Native">
        For React Native, you can set the default renderer for **Android** using `RiveRenderer.defaultRenderer`.

        If you do not set a renderer, React Native uses the default renderer.

        - Android options: `Rive (default) / Canvas`

        <Info>
            See the **Android** sections for additional information on renderers and fallbacks.
        </Info>
