...
The [Rive Renderer](https://rive.app/renderer) is now available on Android and iOS. See [Specifying a Renderer](#specifying-a-renderer) to set it as your preferred renderer.
