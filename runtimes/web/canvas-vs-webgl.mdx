...
- Support for [Rive Text](https://app.outverse.com/rive/doc/text-overview/docSfhykWoWu)
...
- [Rive Text](https://app.outverse.com/rive/doc/text-overview/docSfhykWoWu)
...
For more information about the Rive Renderer, see the [Choose a Renderer](https://help.rive.app/runtimes/renderer) section.
...
See an example of usage here: [https://codesandbox.io/s/rive-canvas-advanced-api-basketball-rgted8](#background)
...
See an example of usage here: [https://codesandbox.io/s/rive-webgl-advanced-api-fwtmdb](#background)
