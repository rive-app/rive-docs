...
You only need to use this function if you are using Rive's [low-level APIs](https://app.outverse.com/rive/doc/low-level-api-usage/doctAfBY6v3P)[ ](https://app.outverse.com/rive/doc/low-level-api-usage/doctAfBY6v3P)to build the render loop manually and are integrating Rive into your existing `requestAnimationFrame()` loop
