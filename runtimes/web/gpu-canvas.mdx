---
title: "GPU Canvas"
description: "Opt a Rive instance into GPU Canvas to render 3D and shader content on the web."
---
...
A `RiveFile` takes the same flag. The flag is fixed when the file is imported and has no setter, so set it when you construct the file:
