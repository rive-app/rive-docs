...
<Columns cols={2}>
  <RiveCard
    ...
    description="The cat will follow your cursor, even when it's outside the bounds of the canvas."
    link="https://codesandbox.io/p/sandbox/tracking-mouse-cursor-n38gdd?file=%2Fsrc%2Findex.ts"
  >
    <ExampleEyeFollow />
  </RiveCard>
</Columns>
