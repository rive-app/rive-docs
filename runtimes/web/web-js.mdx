...
<Steps>
  <Step title="Install the dependency">
    <Tip>
      We recommend always using the [latest version](https://www.npmjs.com/package/@rive-app/webgl2) when possible.
    </Tip>
    <Tabs>
      <Tab title="Script Tag">
        **(Recommended) Load v2 of the web runtime**

        Add the following script tag to your web page to load the latest version of the web runtime:
        ```html
