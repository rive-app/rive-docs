...
<Tabs>
    <Tab title="Web">
    See [this video](https://x.com/rive_app/status/1907115949234467091) for an overview of data binding using the Web API along with this [CodeSandbox example](https://codesandbox.io/p/sandbox/rive-data-binding-quick-start-js-6v2ltn?file=%2Fsrc%2Findex.mjs%3A25%2C35)
    </Tab>
    <Tab title="React">
        <DataBindingReact></DataBindingReact>
    </Tab>
