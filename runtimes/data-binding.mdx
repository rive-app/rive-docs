...
<Tabs>
    ...
    <Tab title="Apple">
        ...
        guard let file = riveViewModel.riveModel?.riveFile else { return }
        ...
        guard let artboard = riveViewModel.riveModel?.artboard else { return }
...
<Tabs>
    ...
    ```swift
        let riveViewModel = RiveViewModel(...)
        guard let file = riveViewModel.riveModel?.riveFile,
            let viewModel = file.viewModelNamed("...")
            else { return }
...
<Tabs>
    ...
    <Tab title="Apple">
        ```swift
        let riveViewModel = RiveViewModel(...)
        guard let artboard = riveViewModel.riveModel?.artboard,
...
<Tabs>
    ...
    <Tab title="Apple">
        ```swift
        let riveViewModel = RiveViewModel(...)
        guard let viewModel = riveViewModel.riveModel?.file.viewModelNamed(...) else { return }
...
<Tabs>
    ...
    <Tab title="Apple">
        ```swift
        let riveViewModel = RiveViewModel(...)
        guard let instance = riveViewModel.riveModel?.riveFile.viewModelNamed("...")?.createDefaultInstance() else { return }
        
        // An example of getting a string property
        let stringProperty = instance.stringProperty(fromPath: "...")
        // Updating its value
        stringProperty?.value = "Hello, Rive"
        // Subscribing to value changes
        let listener = stringProperty?.addListener { value in
            print(value)
        }
        // Unsubscribing from value changes
        stringProperty?.removeListener(listener)

        // You can also update and listen without storing a strong reference
        instance.stringProperty(fromPath: "...").value = "Hello again, Rive"

        // Other properties are similar (value setter / getter), such as number, boolean, etc.
        // Triggers can additionally be listened to for when they are triggered
        ```
    </Tab>
</Tabs>
...
<Tabs>
    ...
    <Tab title="Apple">
        ...
        let nestedNumberByChain = instance
                                    ...
                                    .numberProperty(fromPath: "Nested View Model/Another Nested View Model")

        let nestedNumberByPath = instance.numberProperty(fromPath: "Nested View Model/Another Nested View Model")
        ```
    </Tab>
</Tabs>
