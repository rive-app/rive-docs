...
<Tabs>
    ...
    <Tab title="Unity">
        ```csharp
        // Enable auto-binding through the Inspector:
        // 1. Select your RiveWidget in the Inspector
        // 2. In the "Data" section, set Data Binding Mode to "Auto Bind Default" or "Auto Bind Selected"
        // 3. If using "Auto Bind Selected", choose the instance from the dropdown
        
        // Or programmatically before the widget is loaded:
