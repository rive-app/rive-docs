...
<Tabs>
  ...
  <Tab title="Apple">
    <Tabs>
        ...
        View models are not their own type; rather, they are a source to create a view model instance from.
...
<Tabs>
  ...
  <Tab title="Apple">
    <Tabs>
        <Tab title={Apple.currentRuntimeName}>
            The following section assumes that you have read through the [Apple](/runtimes/apple/apple.mdx) overview.
  ...
  <Tab title="Apple">
    <Tabs>
        <Tab title={Apple.currentRuntimeName}>
            ...
            Setters, getters, and triggers for types are now a part of `ViewModelInstance` objects.
