    ...
    <Tab title="Web">
        ...
        <Columns cols={2}>
            <Card
                ...
                img="/images/app-runtimes/data-binding/rive-db-lists.webp"
                href="https://codesandbox.io/p/sandbox/suspicious-hertz-2lg4m8?file=%2Fsrc%2Findex.ts"
            >
        ...
        Use the `useViewModelInstanceList` hook to manage list properties on view model instances.
         ...
         <Columns cols={2}>
            <Card
                title="Example: Data Binding Lists"
                img="/images/app-runtimes/data-binding/rive-db-lists.webp"
                href="https://codesandbox.io/p/sandbox/rive-react-data-binding-lists-4msh9z?file=%2Fsrc%2FApp.tsx"
            >
...
<Tabs>
    ...
    <Columns cols={2}>
        <Card
            ...
            img="/images/app-runtimes/data-binding/rive-data-bind-components.webp"
            href="https://codesandbox.io/p/sandbox/rive-js-data-binding-artboards-jx3pf9?file=%2Fsrc%2Findex.mjs%3A5%2C19"
        >
    ...
    <Columns cols={2}>
        <Card
            title="Example: Data binding Artboards"
            img="/images/app-runtimes/data-binding/rive-data-bind-components.webp"
            href="https://codesandbox.io/p/sandbox/rive-react-data-binding-artboards-kmvzh8?file=%2Fsrc%2FApp.tsx"
        >
            Swap an artboard with another artboard from the same .riv or one loaded at runtime.
        </Card>
    </Columns>
