...
<Tabs>
    <Tab title="Web">
        ...
        <Columns cols={2}>
            <Card
                title="Example: Lists with JS"
                img="/images/app-runtimes/data-binding/rive-data-binding-lists.webp"
                href="https://codesandbox.io/p/sandbox/suspicious-hertz-2lg4m8?file=%2Fsrc%2Findex.mjs"
            >
