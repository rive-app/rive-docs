...
<Tabs>
    ...
    <Tab title="Flutter">
        ...
        final vmiIndexed = vm.createInstanceFromIndex(i);
        }

        // Create by name
        final vmiNamed = vm.createInstanceFromName("My Instance");
...
<Tabs>
    ...
    <Tab title="Flutter">
        <Info>Flutter (rive_native) does not yet support `viewModel.properties`.</Info>
    </Tab>      
</Tabs>
...
<Tabs>
    ...
    <Tab title="Flutter">
        ...
        // Dispose of the property to clear up resources.
...
<Tabs>
    ...
    <Tab title="Flutter">
        <Info>Flutter (rive_native) does not yet support `file.enums`.</Info>
    </Tab>      
</Tabs>
...
<Tabs>
    ...
    <Tab title="Flutter">
        ```dart
        final vm = file.viewModelByName("My View Model")!;
        final vmi = vm.createInstanceFromName("My Instance")!;
