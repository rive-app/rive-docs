...
<ExamplesCards examples={['dataBindingImages']} runtime="web" />
<Tabs>
  <Tab title="Web">
...
<ExamplesCards examples={['dataBindingLists']} runtime="web" />
<Tabs>
  <Tab title="Web">
  ...
  <Tab title="React">
    ...
    <ExamplesCards examples={['dataBindingLists']} runtime="react" />
    ```typescript
...
<Tabs>
  <Tab title="Web">
    ...
    <ExamplesCards examples={['dataBindingArtboards']} runtime="web" />
  ...
  <Tab title="React">
    ...
    <ExamplesCards examples={['dataBindingArtboards']} runtime="react" />
