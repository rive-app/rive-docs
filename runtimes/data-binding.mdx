...
<Tabs>
  ...
  <Tab title="Android">
    ...
    val firstInstance = animationView.file!!.getViewModelByName("First").createDefaultInstance()
    listProperty.add(firstInstance)

    val secondInstance = animationView.file!!.getViewModelByName("Second").createDefaultInstance()
