...
import { RivePlayer } from '/snippets/rive-player.jsx'
...
<Tabs>
  <Tab title="Web">
    **Examples**
    ...
    <ExamplesCards examples={['dataBindingImages', 'layouts']} runtime="web">
      <RiveCard
        title="Responsive Layouts"
        description="Create responsive layouts that adapt to different screen sizes."
        link="https://codesandbox.io/p/devbox/rive-responsive-layout-js-forked-m77nlw?file=%2Fsrc%2Findex.ts%3A10%2C1"
      >
        <ExampleEyeFollow />
      </RiveCard>
      <RiveCard
