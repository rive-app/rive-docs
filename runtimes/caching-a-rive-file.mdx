...
<Tabs>
  ...
  <Tab title="Android">
    To cache a rive file in Android, you can use the Rive `File` class to load and cache the file. That `File` can then be reused across multiple `RiveAnimationView` instances. Here's a basic example:
