...
<Tabs>
  <Tab title="New Runtime (Recommended)">
    ...
    <ResponseField name="bindViewModelInstance(viewModelInstance)" type="(viewModelInstance: ViewModelInstance) => void">
      Binds a view model instance to the Rive view. See the [Data Binding](/runtimes/react-native/data-binding) documentation for more details.
    </ResponseField>
    ...
    <ResponseField name="setTextRunValue(name, value, path?)" type="(name: string, value: string, path?: string) => void">
      ...
      <Warning>
        This method is deprecated. Use data binding instead. See the [Data Binding](/runtimes/react-native/data-binding) documentation.
      </Warning>
    </ResponseField>
  ...
  <Tab title="Legacy Runtime">
    ...
    **Example:**
    ...
    - `textRunName` - Name of the text run to set a new text value on. Read more on text runs here: [Text](/runtimes/react-native/text)
