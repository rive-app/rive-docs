...
<Note>
 See [our documentation](https://app.outverse.com/rive/doc/adding-rive-to-expo/docFSwIlblYi)[ ](https://app.outverse.com/rive/doc/adding-rive-to-expo/docFSwIlblYi)to add Rive to an Expo app.
</Note>
