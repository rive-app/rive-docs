...
If you’re using Expo SDK 52 or later, as it already requires `15.1` or later.
...
See [Loading in Rive Files](/runtimes/react-native/loading-rive-to-expo) for instructions on working with local assets.
