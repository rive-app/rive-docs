...
### Option 1: Using `require()` (Recommended)
    ...
    Loading Rive files using `require()` is recommended because it doesn't require a native rebuild when you update the file. With Expo, this also enables Over The Air (OTA) updates.
