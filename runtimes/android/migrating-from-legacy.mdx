...
// Property
riveFile.controller.fit = Fit.CONTAIN
riveFile.controller.alignment = Alignment.CENTER
```
...
```kotlin
class MyAssetLoader : FileAssetLoader(context: Context) : ContextAssetLoader(context) {
...
<Card icon="Pencil" href="https://github.com/rive-app/rive-android/blob/master/app/src/main/java/app/rive/runtime/example/RiveSnapshotActivity.kt" horizontal>
