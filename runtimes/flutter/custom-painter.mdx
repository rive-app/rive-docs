...
For additional information/inspiration take a look at the [Rive GameKit for Flutter documentation](/rive-gamekit/). Similar techniques can be used to create more complex scenes and layouts using the Rive Flutter runtime.