...
The [Flame game engine](https://docs.flame-engine.org/latest/) makes use of the techniques discussed below to render Rive animations. Some of the code in this example is taken from the [flame_rive package](https://pub.dev/packages/flame_rive).
...
![Image](https://ucarecdn.com/d88d3230-4bb6-4ca6-b3a8-7715737c3ead/)
...
![Image](https://ucarecdn.com/1fc55311-9c05-44b2-86b3-3ce836c7733e/)

<Note>
 Note that `.instance()` is called on the artboard to create a unique instance that can be advanced on it's own.
</Note>

For additional information/inspiration take a look at the[ ](https://app.outverse.com/rive/doc/overview/dochMzQqsILp)[Rive GameKit for Flutter documentation](https://app.outverse.com/rive/doc/overview/dochMzQqsILp). Similar techniques can be used to create more complex scenes and layouts using the Rive Flutter runtime.