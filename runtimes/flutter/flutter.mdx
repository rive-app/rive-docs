...
<Note>
  There is a new major version of Rive Flutter, `0.15.x`, currently available as a dev release. See the [migration guide](/runtimes/flutter/migration-guide#version-0-15-0) for what changed. Try it out and let us know what you think.
</Note>
