...
<Note>Hosted assets are only available on Voyager and Enterprise plans. [Learn more about our plans and pricing](https://rive.app/pricing).</Note>
...
<Demos examples={["fontsHostedCompressed"]} />
