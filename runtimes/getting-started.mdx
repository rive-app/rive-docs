...
You'll also find pages dedicated to controlling your Rive graphics at runtime. For example, updating data bound properties and loading in assets out-of-band. See [Graphic control and interaction](#animation-control-and-interaction) below.
...
These sections provide details on how to interact with your Rive graphics at runtime. Here, you'll find documentation and code samples for all of Rive's official runtimes.
