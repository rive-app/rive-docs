...
<FeatureSupportGroup feature="textInput" />
<FeatureSupportGroup feature="focus" />
<FeatureSupportGroup feature="statefulComponents" />
<FeatureSupportGroup feature="gpuCanvas">
  GPU Canvas enables 3D and shader content. See each runtime section for more details.
</FeatureSupportGroup>
