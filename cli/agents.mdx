...
<Steps>
  <Step title="Create a project">
    ...
    `rive create` writes an `AGENTS.md` and `CLAUDE.md` into the folder. Agents read this when
    they open the directory, and it tells them how to look up the CLI reference and
  ...
  <Step title="Describe what you want">
    ...
    result with `rive <dir> --verify` and `rive inspect --summary`, the two checks
    `AGENTS.md` tells it to run. Ask for a `rive <dir> --screenshot` when you want to
    see it.
