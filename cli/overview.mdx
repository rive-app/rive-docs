...
Pair the CLI with your agent of choice to build your scene from scratch, or modify and inspect an existing Rive graphic from your account. You describe the graphic, the agent writes the scene in [Rive Markup Language (RML)](/runtimes/advanced-topic/rml), and you watch the
